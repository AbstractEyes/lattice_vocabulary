...
class ProjectiveHead(nn.Module):
    ...
    def __init__(
        ...
        num_heads = max(1, min(8, self.bottleneck_dim // 64))
    ...
    def _init_pentachora_validated(
        ...
        for bin_idx in range(num_bins):
            ...
            for pattern_idx in range(num_patterns):
                ...
                simplex = factory.create_simplex(subseed=subseed)
...
class GeometricMultiScaleLoss(nn.Module):
    ...
    def forward(
        ...
        for block_name, outputs in companions_outputs.items():
            ...
            feature_sim_loss = 1.0 - F.cosine_similarity(z, teacher_features_norm, dim=-1).mean()
